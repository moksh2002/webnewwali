...
namespace WebApplication7
{
    public partial class viewproduct : System.Web.UI.Page
    {
        ...
        {
                SqlCommand cmd = new SqlCommand();
                SqlConnection con = new SqlConnection("Initial catalog=scarLife; integrated security=true;server=VDILEWVPNTH516");
        ...
        protected void GridView1_RowUpdating1(object sender, GridViewUpdateEventArgs e)
        {
            ...
            SqlConnection con1 = new SqlConnection("Initial catalog=scarLife; integrated security=true;server=VDILEWVPNTH516");
            SqlCommand cmd = new SqlCommand();
