<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewuserproduct.aspx.cs" Inherits="WebApplication7.viewuserproduct" %>
...
&nbsp;
  ...
  <a class="navbar-brand" href="#"><h3>Admin Page</h3></a><br /><br />
        ...
        <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" Height="160px" Width="295px" OnRowDataBound="GridView1_RowDataBound" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" >
            ...
            <SortedDescendingHeaderStyle BackColor="#000065" /><Columns>
