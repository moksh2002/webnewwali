...
&nbsp;
  ...
  <a class="navbar-brand" href="#"><h3>Admin Page</h3></a><br /><br />
          ...
          <center> <div class="col-md-1"  style="height:300px;width:80%;  ">
            <asp:GridView ID="GridView1" runat="server" Height="272px"  Width="392px" CellPadding="3" GridLines="Vertical" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px">
